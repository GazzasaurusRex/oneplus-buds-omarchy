...
- Native EQ exposes five verified factory IDs: 0 Balanced, 1 Bass, 2 Serenade,
  3 Bold, and 7 Hans Zimmer Soundscape Tuning. HeyMelody-to-protocol mapping was
  read back on firmware `196.196.101`. It also exposes two device-declared custom
  entries with six bands at 62/250/1000/4000/8000/16000 Hz and -6..+6 dB limits.
  All presets and a reversible custom update were read back and audibly confirmed.
  Both custom slots and the original selection were restored exactly afterward.
  A closed-case 60-second disconnect/reconnect retained the selected Custom ID 4
  curve and flat Custom1 definition through a fresh post-cycle query.
