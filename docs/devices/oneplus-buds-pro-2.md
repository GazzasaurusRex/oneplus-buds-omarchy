...
- Native EQ exposes four verified factory presets and two device-declared custom
...
- Full earbud power-cycle EQ persistence and unverified firmware-gated preset ID 7
